...
- **`./Arma3Helper.sh launchopts`**: Ensure Arma's Steam launch options expose the host paths ACRE2/TFAR need (required since Steam Linux Runtime 4 isolates the game container)
